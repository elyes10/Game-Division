...
public class orders {
    ...
    public orders(int order_id, int user_id, String adr_livraison, String country, int post_code, Date date_commande, float total_price, String status, String liste_produit) {
