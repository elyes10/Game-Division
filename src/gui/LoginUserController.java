    ...
    @FXML
     public void loginAction(ActionEvent event) throws Exception{
        ...
        String password = tfpwd.getText();
                    ...
                    PreparedStatement st = (PreparedStatement) c.prepareStatement("Select User_Email, User_password, User_id, user_role from users where User_Email=? and User_password=?");
   try {
                    ...
                    session_user_id=rs.getInt("User_id");
                        System.out.println(session_user_id+"id user");
         ...
         Parent root = FXMLLoader.load(getClass().getResource("/gui/Shop.fxml")); 
            ...
            primaryStage.show();
                        ...
                        else {Parent root = FXMLLoader.load(getClass().getResource("/gui/adminsmenu.fxml"));
                        Scene scene = new Scene(root);
