...
public class ShowUsersController implements Initializable {
    ...
    private void ok(ActionEvent event) throws SQLException {    
            ...
            SimpleStringProperty nameu=new SimpleStringProperty(updname.getText());
            SimpleStringProperty lastnameu=new SimpleStringProperty(lastname.getText());
            SimpleStringProperty emailu=new SimpleStringProperty(updmail.getText());
            SimpleStringProperty pic=new SimpleStringProperty(updphoto.getText());
            SimpleIntegerProperty inputphone=new SimpleIntegerProperty(Integer.parseInt(updphone.getText()));
            
            
            servicesUser su = new servicesUser();
           // User u = new User(nameu, lastnameu, emailu, phoneu,  pic );
            User u = new User();
            u.setUser_name(nameu);
            u.setUser_lastname(lastnameu);
            u.setUser_photo(pic);
            u.setUser_phone(inputphone);
            u.setUser_Email(emailu);
